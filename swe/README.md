...
1. **Source code** in a Git repository (GitHub, GitLab, or similar)
...
These are not required, but can help demonstrate additional capabilities:
...
If anything is unclear or you have questions about the requirements, reach out to us. We're happy to clarify. Asking good questions is a positive signal, not a negative one.
